...
const Footer = ({ title1, title2 }) => {
  return (
    <div className="h-full lg:h-[60vh] w-full bg-color_3 flex flex-col lg:flex-row justify-center items-center gap-3 lg:gap-8 text-center py-5 lg:py-0 px-10 lg:px-28">
      <div className="w-full h-full flex flex-col justify-center items-center font-thin text-[16px] leading-[24px] text-black gap-2 lg:gap-5">
        <h1 className="font-normal">{title1}</h1>
        <h1>{`Le Salama Marrakech Restaurant.`}</h1>
        <h1>{title2}</h1>
      </div>
      ...
      <div className="w-full h-full flex flex-col justify-center items-center font-thin text-[16px] leading-[24px] text-[#000000] gap-2 lg:gap-5">
